...
def main():
    ...
    service_manager.RegisterService(
        hr_service.get_path(), {}, reply_handler=register_service_cb, error_handler=register_service_error_cb
    )
    service_manager.RegisterService(
        bat_service.get_path(), {}, reply_handler=register_service_cb, error_handler=register_service_error_cb
    )
    service_manager.RegisterService(
        test_service.get_path(), {}, reply_handler=register_service_cb, error_handler=register_service_error_cb
    )
